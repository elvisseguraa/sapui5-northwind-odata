		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#esegurademonorthwind1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"esegurademonorthwind1-display": {
								"semanticObject": "esegurademonorthwind1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=esegura.demonorthwind1",
									"url": sap.ui.require.toUrl("esegura/demonorthwind1")
								}
							}
						}
					}
